...
import { Receipt, PlusCircle, LogIn, LogOut, ShieldCheck, LayoutDashboard, ChevronDown } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            {/* Quick Add Expense CTA (Visible to all users, including Admin) */}
            {user && (
              <button
                onClick={onOpenCreateTransaction}
                className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-semibold bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white shadow-sm transition-all hover:shadow cursor-pointer"
              >
