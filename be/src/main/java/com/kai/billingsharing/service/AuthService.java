...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        emailOutboxService.recordOutbox(
                ...
                "Kích hoạt tài khoản Billing Sharing của bạn",
                html,
                payloadJson,
                businessKey,
                LocalDate.now()
    ...
    public Map<String, String> forgotPassword(ForgotPasswordRequest request) {
        ...
        if (user != null && Boolean.TRUE.equals(user.getIsActive())) {
            ...
            emailOutboxService.recordOutbox(
                    ...
                    user.getEmail(),
                    user.getFullName(),
                    "Yêu cầu đặt lại mật khẩu - Billing Sharing",
                    html,
                    payloadJson,
                    businessKey,
                    LocalDate.now()
    ...
    public Map<String, String> resetPassword(ResetPasswordRequest request) {
        ...
        emailOutboxService.recordOutbox(
                ...
                user.getEmail(),
                user.getFullName(),
                "Thông báo bảo mật: Mật khẩu của bạn đã được thay đổi - Billing Sharing",
                html,
                null,
                businessKey,
                LocalDate.now()
